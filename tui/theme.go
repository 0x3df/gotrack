...
type ThemePalette struct {
	...
	StarBright      string
	StarTrail       string
	// ASCIIOnly signals renderers to prefer ASCII glyphs over block/Unicode
	// characters. High-contrast themes set this to maximize legibility in
	// basic terminals and with screen readers.
	ASCIIOnly bool
}
...
func paletteForTheme(name models.ThemeName) ThemePalette {
	...
	case models.ThemeAccessible:
		return ThemePalette{
			Name:            models.ThemeAccessible,
			Primary:         "15", // bright white
			Border:          "7",  // white
			Muted:           "7",  // white
			Success:         "11", // bright yellow (colorblind-safer than green)
			Danger:          "9",  // bright red
			ActiveTabBg:     "11",
			ActiveTabFg:     "0",
			InactiveTab:     "7",
